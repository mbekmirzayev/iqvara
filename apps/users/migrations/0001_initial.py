# Generated by Django 5.2.7 on 2025-10-16 05:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.UUIDField(
                        db_default=apps.shared.models.GenRandomUUID(),
                        editable=False,
                        primary_key=True,
                        serialize=False,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    models.ManyToManyField(related_name="blogs", to="users.category"),
                ),
                (
                    "tags",
                    models.ManyToManyField(
                        blank=True, related_name="blogs", to="users.tag"
                    ),
                ),
            ],
            options={
