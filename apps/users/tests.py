...
python manage.py loaddata apps/fixtures/users/users.json
python manage.py loaddata apps/fixtures/course/categories.json
python manage.py loaddata apps/fixtures/tags/tags.json
python manage.py loaddata apps/fixtures/course/courses.json
python manage.py loaddata apps/fixtures/course/lessons.json
python manage.py loaddata apps/fixtures/course/reviews.json
