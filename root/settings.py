...
JAZZMIN_SETTINGS = {
    ...
    # LOGO UCHUN:
    # "site_logo": "apps/images/logo.png",  # static/images/logo.png
    # "site_logo_classes": "img-circle",  # dumaloq ko‘rinish
    "site_logo_classes": "img-circle object-cover",
    "site_logo_height": "12px",  # hajmi kichik

    # Qo‘shimcha ixtiyoriy sozlamalar
    "login_logo": "images/logo.png",  # login sahifasida ham chiqadi
